...
pub fn prepare_env() {
    #[cfg(target_os = "linux")]
    {
        ...
        // Der DMABUF-Renderer von WebKitGTK lässt das Fenster auf manchen
        // Systemen (vor allem mit NVIDIA-Treiber) leer, siehe den Hinweis in
        // scripts/install-linux.sh. Er wird deshalb abgeschaltet.
